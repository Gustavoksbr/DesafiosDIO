...
public class MonitoramentoTemperatura implements MonitoramentoTemperaturaPresenter {
    public static void main(String[] args) {
       ...
       MonitoramentoTemperaturaUseCase casoDeUso = new MonitoramentoTemperaturaUseCaseImpl();
        ...
        MonitoramentoTemperaturaController controller = new MonitoramentoTemperaturaController(casoDeUso,new MonitoramentoTemperatura());
